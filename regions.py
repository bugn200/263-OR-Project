...
dfDemands = pd.read_csv('data/WoolworthsDemands.csv')
dfDurations = pd.read_csv('data/WoolworthsTravelDurations.csv')
dfLocations = pd.read_csv('data/WoolworthsLocations.csv')
